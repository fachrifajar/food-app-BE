...
const getComments = async (params) => {
  ...
  return await db`SELECT accounts.accounts_id, accounts.username, accounts.profile_picture, accounts.email, comments.comment, comments.id AS comments_id, comments.updated_at
  FROM comments
